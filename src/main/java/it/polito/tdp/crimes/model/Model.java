...
//		System.out.println("# ARCHI: " + grafo.edgeSet().size());
	...
	public List<Adiacenza> getArchiMaggioriPesoMedio(){
		...
		//riscorro gli archi prendendo quelli maggiori alla media
	...
	private void cerca(List<String> parziale, String destinazione) {
		//condizione di terminazione, se l'ultimo elemento di parziale è destinazione
